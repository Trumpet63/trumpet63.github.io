(() => {
  // pages/test-javascript-time-granularity/src/index.js
  ...
  var samples = [];
  var samplesMaxSize = 2e3;
  var startTime = performance.now();
  var previousSample = startTime;
  var currentSample = startTime;
  while (samples.length < samplesMaxSize && currentSample - startTime < 5e3) {
